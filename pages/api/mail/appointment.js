    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <span class="preheader"
          >This is a booking for an appointment.</span
        >
        <table
          class="email-wrapper"
          width="100%"
                      ...
                      <tr>
                        <td class="content-cell">
                          ...
                          Appoinment
                            ...
                            <p>
                              A new appointment has been booked for ${formatDate(
                                data.time
                              )}
                            </p>

                            <p>From, <br />${data.prefix}. ${data.firstName} ${
      data.lastName
    } <br />${data.email} <br />${data.phoneNumber}</p>
                            <!-- Action -->
                            <table
                              class="body-action"
                              align="center"
